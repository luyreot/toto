...
class NumberStats(
    ...
    override val patterns: Map<Int, Int>
        get() = patternsCache
    private val patternsCache = mutableMapOf<Int, Int>()

    override val frequencies: Map<Int, List<Frequency>>
    ...
    fun calculateStats() {
        ...
        drawings.forEachIndexed { index, numbers ->
            numbers.numbers.forEach { number ->
                ...
                patternsCache.merge(number, 1, Int::plus)
    ...
    private fun validateNumberOccurrences() {
        if (patternsCache.size != totoType.totalNumbers)
    ...
    private fun validateNumberFrequencies() {
        ...
        if (patternsCache.size != frequenciesCache.size)
        ...
        patternsCache.forEach { (number, occurrences) ->
